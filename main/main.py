...
#ПЕРВЫЙ ПРОВЕРЕЧНЫЙ НЕ ФУНКЦИОНИРУЕТ!!!!!!!!!!!!!!
...
def registration_menu():
    mystat_reg = Frame(main, width=1270, height=750, bg="#FFFFFF")
    ...
    register_text.config(bg='#FFFFFF',
                    fg='black',
                   font= ("Arial" , 19))
    register_text.place(x=45,y=50)

    newlogin = Entry(main, validate="key",bd=0.5,justify="left", fg= "black")
    newlogin.config(
              bg="#FFFFFF",
              fg="grey",
              font= ("Times" , 12), )
    ...
    newpass_input = Entry(main, validate="key",bd=0.5,justify="left", fg= "black")
    ...
    new_gmail = Entry(main, validate="key",bd=0.5,justify="left", fg= "black")
    new_gmail.config(
                bg="#FFFFFF",
                fg="grey",
                font= ("Times" , 12), )
    ...
    go_back_btn = Button(mystat_reg, image=go_back, bd=0, bg='#FFFFFF',command=main)
